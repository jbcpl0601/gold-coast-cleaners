...
export const metadata: Metadata = {
  title: "About Us",
  description:
    "Learn more about Your Trusted Local Cleaning Partner in Gold Coast. Our uniformed, trained, and insured team treats every property with the utmost respect.",
};
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="mt-6 text-lg text-muted-foreground">
                ...
                reliable and high-quality cleaning services across the Gold
                Coast. With years of industry experience, our team understands
                the high standards required by property managers and landlords
                for end-of-lease inspections.
              </p>
              <p className="mt-4 text-lg text-muted-foreground">
                We are a direct service provider, not a franchise or directory.
                This means you get a personal touch, consistent quality, and a
                team that truly cares about helping you secure your bond.
              </p>
            </div>
        ...
        <div className="container relative z-10">
          ...
          <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value) => (
              <Card
                key={value.title}
                className="group border border-primary/20 shadow-sm hover:shadow-2xl hover:border-primary/40 transition-all duration-500 rounded-2xl bg-gradient-to-br from-white/80 to-primary/10 backdrop-blur-md overflow-hidden hover:-translate-y-1">
