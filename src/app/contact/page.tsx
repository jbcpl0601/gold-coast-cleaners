...
export const metadata: Metadata = {
  title: "Contact Us",
  description:
    "Get a free quote for bond, carpet, or spring cleaning on the Gold Coast. Contact James Bond Cleaning via our form, phone, or email. We're ready to help!",
};
      ...
      <div className="container relative z-10">
        <div className="text-center">
          ...
          <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto">
            Ready for a sparkling clean property? Contact us today for a free,
            no-obligation quote. We're here to answer any questions you may
            have.
          </p>
        </div>
